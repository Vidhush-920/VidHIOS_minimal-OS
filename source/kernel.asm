;VidHI --- The VidHIOS Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE VidHIOS_VER '1.0.0'	;OS version number
	%DEFINE VidHIOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as VidHIOS and its programs
...
option_screen:
	...
	os_init_msg		db '@@@@*************////\\\\Welcome to VidHIOS////\\\\****************@@@@', 0
	os_version_msg		db 'Version ', VidHIOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', VidHIOS_VER, 0

	dialog_string_1		db 'Welcome to VidHIOS Operating System', 0
...
os_draw_background1:
	...
	mov ah, 09h			; Draw light cyan bar at top
	mov bh, 0
	mov cx, 80
	mov bl,10110001b
	mov al, ' '
	...
	mov ah, 09h			; Draw light cyan bar at bottom
	mov bh, 0
	mov cx, 80
	mov bl, 10110001b
	mov al, ' '
